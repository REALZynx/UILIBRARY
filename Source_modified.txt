...
local Library do
	...
	Library.Watermark = function(self, Name)
		...
		local Items = { } do
			-- Container utama: background gelap, rounded, compact seperti Linoria
			...
			-- Accent bar di kiri (ciri khas Linoria)
			...
			-- Padding konten (kiri lebih besar untuk accent bar)
			Instances:Create("UIPadding", {
				Parent = Items["Watermark"].Instance,
				Name = "\0",
				...
				PaddingLeft = UDimNew(0, 13)
			})

			-- Text label: nama script + info FPS/Ping di satu baris
			Items["Text"] = Instances:Create("TextLabel", {
				Parent = Items["Watermark"].Instance,
				Name = "\0",
				FontFace = Library.Font,
		...
		Library:Connect(RunService.RenderStepped, function()
			...
			-- Warna FPS: hijau > 60, kuning 30-60, merah < 30
			local FpsColor = FramesPerSecond >= 60 and "<font color='#7dff7d'>%d</font>"
				or FramesPerSecond >= 30 and "<font color='#ffd97d'>%d</font>"
				or "<font color='#ff7d7d'>%d</font>"

			-- Warna Ping: hijau < 80, kuning 80-150, merah > 150
			local PingColor = Ping < 80 and "<font color='#7dff7d'>%d</font>"
				or Ping < 150 and "<font color='#ffd97d'>%d</font>"
				or "<font color='#ff7d7d'>%d</font>"

			local FpsText = StringFormat(FpsColor, FramesPerSecond)
			local PingText = StringFormat(PingColor, Ping)

			Items["Text"].Instance.Text = StringFormat(
				"<b>%s</b>  <font color='#aaaaaa'>fps</font> %s  <font color='#aaaaaa'>ping</font> %s<font color='#aaaaaa'>ms</font>",
				Name, FpsText, PingText
			)
		end)
